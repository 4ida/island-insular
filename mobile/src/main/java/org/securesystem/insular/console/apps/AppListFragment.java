package org.securesystem.insular.console.apps;
...
import org.securesystem.insular.featured.FeaturedListViewModel;
import org.securesystem.insular.guide.UserGuide;
import org.securesystem.insular.mobile.BuildConfig;
import org.securesystem.insular.mobile.R;
import org.securesystem.insular.mobile.databinding.AppListBinding;
import org.securesystem.insular.model.AppListViewModel;
import org.securesystem.insular.settings.SettingsActivity;
import org.securesystem.insular.tip.Tip;
...
//					Snackbars.withAction(android.R.string.ok, v -> AppLaunchShortcut.createOnLauncher(activity, pkg))).show();
	...
	@Override public boolean onOptionsItemSelected(final MenuItem item) {
		...
		else if (id != R.id.menu_test) return super.onOptionsItemSelected(item);
		return true;
	}
