...
@SuppressLint("InlinedApi") public class ApiConstants {
	 ...
	 */
	static final String TYPE_DELEGATION = "org.securesystem.insular.delegation";	// Name-spaced as requirement mentioned by RestrictionsManager.requestPermission()
	 ...
	 */
	public static final String REQUEST_KEY_USER_SERIAL_NUMBER = "org.securesystem.insular.request.user";
