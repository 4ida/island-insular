...
public class Api {
	...
	interface v2 extends v1 {
		...
		String PERMISSION_FREEZE_PACKAGE = "org.securesystem.insular.permission.FREEZE_PACKAGE";
		String PERMISSION_LAUNCH_PACKAGE = "org.securesystem.insular.permission.LAUNCH_PACKAGE";
		String PERMISSION_SUSPEND_PACKAGE = "org.securesystem.insular.permission.SUSPEND_PACKAGE";
		 ...
		 * <p>Result: {@link Activity#RESULT_OK} for success, {@link Activity#RESULT_CANCELED} for failure or {@link latest#RESULT_UNVERIFIED_IDENTITY}
		 */
		@Since(2.1) @TargetApi(N) @RequiresPermission(PERMISSION_SUSPEND_PACKAGE) String ACTION_SUSPEND = "org.securesystem.insular.action.SUSPEND";

		/**
		 * Unsuspend the app(s) specified by Intent data with "package" or "packages" (comma-separated) scheme. (requires Android N+)
		 * <p>Result: {@link Activity#RESULT_OK} for success, {@link Activity#RESULT_CANCELED} for failure or {@link latest#RESULT_UNVERIFIED_IDENTITY}
		 */
		@Since(2.1) @TargetApi(N) @RequiresPermission(PERMISSION_SUSPEND_PACKAGE) String ACTION_UNSUSPEND = "org.securesystem.insular.action.UNSUSPEND";
	...
	interface v1 {
		@Since(1.0) String ACTION_FREEZE   = "org.securesystem.insular.action.FREEZE";
		@Since(1.1) String ACTION_UNFREEZE = "org.securesystem.insular.action.UNFREEZE";
		...
		@Since(1.1) String ACTION_LAUNCH   = "org.securesystem.insular.action.LAUNCH";
