package org.securesystem.insular.util;
...
public class Modules {
	...
	public static final String MODULE_ENGINE = "org.securesystem.insular";
	...
	public static @NonNull ComponentName getMainLaunchActivity(final Context context) {
		...
		return new ComponentName(MODULE_ENGINE, "org.securesystem.insular.MainActivity");		// Hard-coded activity name as fallback.
	}
