...
import static org.securesystem.insular.appops.AppOpsCompat.GET_APP_OPS_STATS;
...
public class DevicePolicies {
	...
	public static final String ACTION_PACKAGE_UNFROZEN = "org.securesystem.insular.action.PACKAGE_UNFROZEN";
